...
return [
    ...
    */
    ...
    'disks' => [
        ...
        // Secure uploads disk - outside public root for security
        'secure_uploads' => [
            'driver' => 'local',
        ...
        /*
        |--------------------------------------------------------------------------
        | Backup S3 Disk (Dedicated for encrypted backups)
        |--------------------------------------------------------------------------
        |
        | This disk is specifically configured for backup storage with:
        | - Private access only
        | - Server-side encryption (AES-256)
        | - Versioning enabled (configured in S3 bucket settings)
        |
        */
        'backups-s3' => [
            'driver' => 's3',
            ...
            'visibility' => 'private',
            'throw' => true, // Throw exceptions on backup failures
            'report' => true,
