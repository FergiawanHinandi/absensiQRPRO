...
namespace App\Domain\Attendance\StateMachine;
 ...
 * Provides a pure domain representation of state transitions
 * without Eloquent model coupling.
 * 
 * This ensures state transition rules are enforced at the domain level,
 * preventing invalid state changes.
 * 
 * @package App\Domain\Attendance\StateMachine
 */
