 ...
 * 
 * Domain aggregate that encapsulates all business logic and invariants
 * for attendance records. This is the WRITE MODEL in CQRS architecture.
 * 
 * Responsibilities:
 ...
 * 
 * @package App\Domain\Attendance\Aggregates
 */
class AttendanceAggregate extends AggregateRoot
{
