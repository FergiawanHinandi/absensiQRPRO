...
export const LoginScreen = ({ navigation }: any) => {
    ...
    const { securityState, isSecure, riskLevel, deviceFingerprint } = useDeviceSecurity();
            ...
            try {
                ...
                if (result.riskLevel === 'critical') {
                    Alert.alert(
                        ...
                        result.violations[0]?.message || 'Perangkat tidak memenuhi persyaratan keamanan',
                        [{ text: 'OK' }]
                    );
                }
            } finally {
    ...
    const handleLogin = async () => {
        ...
        try {
            ...
            console.error(error);
            const msg = error.response?.data?.message || 'Gagal login (Cek koneksi/server)';
    ...
    return (
        <View style={styles.container}>
            <View style={styles.card}>
                ...
                <Text style={styles.subtitle}>Login Siswa</Text>
