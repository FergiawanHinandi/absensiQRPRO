...
import {
  sslPinningConfig,
  getSSLPinningOptions,
  shouldPinURL,
} from '../config/sslPinning';
...
const SSL_ERROR_MESSAGES = {
  en: {
    ...
    certificateError:
      'Cannot verify server security. Please update your app or contact support.',
    networkError:
  ...
  id: {
    pinningFailed:
      'Koneksi aman gagal. Silakan periksa koneksi internet Anda dan coba lagi.',
    certificateError:
      'Tidak dapat memverifikasi keamanan server. Silakan perbarui aplikasi atau hubungi support.',
    networkError:
