...
export const useTeacherAbsence = (date?: string) => {
  return useQuery({
    ...
    queryFn: async () => {
      const params = date ? { date } : {};
      const response = await apiClient.get("/admin/dashboard/teacher-absent", {
        params,
      });
...
export const useLateAlpha = (date?: string) => {
  return useQuery({
    ...
    queryFn: async () => {
      const params = date ? { date } : {};
      const response = await apiClient.get("/admin/dashboard/late-alpha", {
        params,
      });
...
export const useAttendanceAnomalies = (date?: string) => {
  return useQuery({
    ...
    queryFn: async () => {
      const params = date ? { date } : {};
      const response = await apiClient.get("/admin/dashboard/anomalies", {
        params,
      });
